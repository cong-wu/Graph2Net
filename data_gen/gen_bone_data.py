...
paris = {
    ...
    'kinetics_min_skeleton': ((0, 0), (1, 0), (2, 1), (3, 2), (4, 3), (5, 1), (6, 5), (7, 6), (8, 2), (9, 8), (10, 9),
...
# 'ntu/xview', 'ntu/xsub',  'kinetics_min_skeleton', 'ntu120/xset', 'ntu120/xsub',
datasets = {
    'kinetics_min_skeleton',
}
# bone
...
for dataset in datasets:
    for set in sets:
        ...
        for v1, v2 in tqdm(paris[dataset]):
            if dataset != 'kinetics_min_skeleton':
                v1 -= 1
                v2 -= 1
