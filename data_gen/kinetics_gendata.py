...
def gendata(data_path, label_path, min_path,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--out_folder', default='../data/kinetics_min_skeleton/')
    ...
    for p in part:
        ...
        min_path = '{}/kinetics_{}_min.txt'.format(arg.data_path, p)
        data_out_path = '{}/{}_data_joint.npy'.format(arg.out_folder, p)
        label_out_path = '{}/{}_label.pkl'.format(arg.out_folder, p)

        gendata(data_path, label_path, min_path, data_out_path, label_out_path)
